package pars.internal.remote.serialization

import cats.effect.IO
import cats.implicits._
import pars.internal.Protocol.Event
import pars.{Channel, ParsSpec, SerializationProvider, Serializer}
import fs2.Stream

case class NormalFormCaseClazz(index: Int, value: String)

class SerializerSpec extends ParsSpec {
