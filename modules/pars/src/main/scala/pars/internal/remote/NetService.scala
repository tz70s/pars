...
import pars.internal.remote.tcp.{SocketClientStream, SocketServerStream, TcpSocketConfig}
import scala.concurrent.duration._

private[pars] class ServerImpl[F[_]: Concurrent: ContextShift](
...
private[pars] class ClientImpl[F[_]: Concurrent: ContextShift](implicit val acg: AsynchronousChannelGroup) {
 ...
 * }}}
 */
private[pars] class NetService[F[_]: Concurrent: ContextShift](implicit val acg: AsynchronousChannelGroup) {
...
private[pars] object NetService {
  val SocketReadBufferSize: Int = pureconfig.loadConfigOrThrow[Int]("pars.remote.buffer-size")
