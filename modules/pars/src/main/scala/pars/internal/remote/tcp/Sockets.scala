package pars.internal.remote.tcp
...
object SocketServerStream {
  ...
  val ServerSocketConfig: TcpSocketConfig = pureconfig.loadConfigOrThrow[TcpSocketConfig]("pars.remote.tcp")
...
object AsyncChannelProvider {
  ...
  private val DefaultWorkStealingPoolSize =
    pureconfig.loadConfigOrThrow[DefaultWorkStealingPoolSizeConfig]("pars.remote.thread-pool.default")
