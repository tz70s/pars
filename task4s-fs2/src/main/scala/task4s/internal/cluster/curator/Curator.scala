 ...
 * INTERNAL API.
 */
private[task4s] class Curator[F[_]: Async](private val async: AsyncCuratorFramework) {
...
private[task4s] class CuratorResource[F[_]: ContextShift: Sync](connection: String) {
...
private[task4s] object CuratorResource {
